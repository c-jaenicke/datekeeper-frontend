<template>
  ...
  <p>
    ...
    Kontaktdaten, Namen, Websitezugriffe und sonstige Daten, die &uuml;ber eine
  ...
  <p>
    GitHub<br />
    88 Colin P Kelly Jr St, San Francisco, <br />
    CA 94107, United States<br />
    <br />
    Hetzner Online GmbH <br />
    Industriestr. 25<br />
    91710 Gunzenhausen, Deutschland <br />
    <br />
    STRATO AG <br />
  ...
  <p>
    ...
    l&auml;dt Ihr Browser die ben&ouml;tigten Web Fonts in ihren Browsercache,
  ...
  <p>
    ...
    Die Nutzung von Google WebFonts erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
  ...
  <p>
    Wenn Ihr Browser Web Fonts nicht unterst&uuml;tzt, wird eine Standardschrift
  ...
  <p>
    ...
    Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den
    Servern von Font Awesome aufnehmen. Hierdurch erlangt Font Awesome Kenntnis
    dar&uuml;ber, dass &uuml;ber Ihre IP-Adresse diese Website aufgerufen wurde.
    Die Nutzung von Font Awesome erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
    DSGVO. Wir haben ein berechtigtes Interesse an der einheitlichen Darstellung
    des Schriftbildes auf unserer Website. Sofern eine entsprechende
  ...
  <p>Letzte &Auml;nderung: 03.07.2022</p>
</template>
